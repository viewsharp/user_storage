...
//go:generate swagger generate server --target ../../gen --name UserStorage --spec ../../swagger.yaml --principal interface{} --exclude-main

func configureFlags(api *operations.UserStorageAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.UserStorageAPI) http.Handler {
